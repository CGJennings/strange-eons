...
public interface QueriedAgnosticDialog extends AgnosticDialog {
     ...
     * to allow this to perform the swap itself. {@code PlatformSupport} will
     * still register listeners for {@link AgnosticDialog#handleOKAction} and
     * {@link AgnosticDialog#handleCancelAction}.
     * <p>
     ...
     *
     * @param swapped {@code true} if the buttons should be swapped based on the
     * order reported to {@code PlatformSupport}
