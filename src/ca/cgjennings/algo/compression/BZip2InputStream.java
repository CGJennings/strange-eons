 ...
 */
 ...
 /*
 * This is a private copy for the compression package.
 * The package has been changed and public classes are now package private.
 * -- CGJ
 */
 ...
 * <tt>BZip2InputStream</tt> to release the allocated memory. See {@link CBZip2OutputStream
 * CBZip2OutputStream} for information about memory usage.</p>
 *
 * <p>
 * <tt>BZip2InputStream</tt> reads bytes from the compressed source stream via
 ...
 */
class BZip2InputStream extends InputStream implements BZip2Constants {
     ...
     * <tt>"Bz"</tt> this constructor expects the next byte in the stream to be
     * the first one after the magic. Thus callers have to skip the first two
     * bytes. Otherwise this constructor will throw an exception. </p>
     *
    ...
    private void getAndMoveToFrontDecode() throws IOException {
        ...
        final int[][] base = dataShadow.base;
        final int[][] perm = dataShadow.perm;
        final int limitLast = this.blockSize100k * 100_000;
