...
class LZMA2Options implements Cloneable {
     ...
     * <p>
     * The sum of {@code lc} and {@code lp} is limited to 4. Trying to
     * exceed it will throw an exception. This function lets you change both at
     * the same time.
     *
     * @throws IllegalArgumentException {@code lc} and {@code lp} are
     * invalid
     */
     ...
     * When {@code lc} is at least 3, the literal coding can take advantage
     ...
     * {@code setLc(2)} too.
     *
     * @throws IllegalArgumentException {@code lc} is invalid, or the sum
     * of {@code lc} and {@code lp} exceed LC_LP_MAX
     */
     ...
     *
     * @throws IllegalArgumentException {@code lp} is invalid, or the sum
     * of {@code lc} and {@code lp} exceed LC_LP_MAX
     */
     ...
     * in general. The default (2) means four-byte alignment (2^{@code pb}
     ...
     * {@code setPb(1)} is a good choice. If the alignment is an odd number
     * like 3 bytes, {@code setPb(0)} might be the best choice.
     * <p>
     * Even though the assumed alignment can be adjusted with {@code setPb}
     * and {@code setLp}, LZMA2 still slightly favors 16-byte alignment. It
     ...
     * The default is {@code MODE_FAST} for presets 0-3 and
     * {@code MODE_NORMAL} for presets 4-9.
     * <p>
     * Usually {@code MODE_FAST} is used with Hash Chain match finders and
     * {@code MODE_NORMAL} with Binary Tree match finders. This is also
     * what the presets do.
     * <p>
     * The special mode {@code MODE_UNCOMPRESSED} doesn't try to compress
     ...
     * {@code niceLen} bytes is found, the algorithm stops looking for
