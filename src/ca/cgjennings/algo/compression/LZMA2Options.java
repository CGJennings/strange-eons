 ...
 * only need {@code LZMA2Options()} or {@code LZMA2Options(int)}.
 */
class LZMA2Options implements Cloneable {
     ...
     * equivalent to {@code LZMA2Options(PRESET_DEFAULT)}.
     */
    public LZMA2Options() {
        try {
     ...
     *
     * @throws IllegalArgumentException {@code preset} is not supported
     */
    public LZMA2Options(int preset) throws IllegalArgumentException {
        setPreset(preset);
    }
     ...
     *
     * @throws IllegalArgumentException unsupported options were specified
     */
     ...
     * @throws IllegalArgumentException {@code preset} is not supported
     */
    public void setPreset(int preset) throws IllegalArgumentException {
     ...
     *
     * @throws IllegalArgumentException {@code dictSize} is not supported
     */
    public void setDictSize(int dictSize) throws IllegalArgumentException {
     ...
     * <p>
     * The sum of {@code lc} and {@code lp} is limited to 4. Trying to exceed it
     * will throw an exception. This function lets you change both at the same
     * time.
     *
     * @throws IllegalArgumentException {@code lc} and {@code lp} are invalid
     */
    public void setLcLp(int lc, int lp) throws IllegalArgumentException {
     ...
     * <p>
     * The literal coding makes an assumption that the highest {@code lc} bits
     * of the previous uncompressed byte correlate with the next byte. For
     ...
     * When {@code lc} is at least 3, the literal coding can take advantage of
     * this property in the uncompressed data.
     * <p>
     * The default value (3) is usually good. If you want maximum compression,
     * try {@code setLc(4)}. Sometimes it helps a little, and sometimes it makes
     * compression worse. If it makes it worse, test for example
     * {@code setLc(2)} too.
     *
     * @throws IllegalArgumentException {@code lc} is invalid, or the sum of
     * {@code lc} and {@code lp} exceed LC_LP_MAX
     */
    public void setLc(int lc) throws IllegalArgumentException {
        setLcLp(lc, lp);
    }
     ...
     *
     * @throws IllegalArgumentException {@code lp} is invalid, or the sum of
     * {@code lc} and {@code lp} exceed LC_LP_MAX
     */
    public void setLp(int lp) throws IllegalArgumentException {
        setLcLp(lc, lp);
    }
     ...
     * in general. The default (2) means four-byte alignment (2^{@code pb} = 2^2
     ...
     * {@code setPb(0)} can improve compression slightly. For UTF-16 text,
     * {@code setPb(1)} is a good choice. If the alignment is an odd number like
     * 3 bytes, {@code setPb(0)} might be the best choice.
     * <p>
     * Even though the assumed alignment can be adjusted with {@code setPb} and
     * {@code setLp}, LZMA2 still slightly favors 16-byte alignment. It might be
     * worth taking into account when designing file formats that are likely to
     * be often compressed with LZMA2.
     *
     * @throws IllegalArgumentException {@code pb} is invalid
     */
    public void setPb(int pb) throws IllegalArgumentException {
        if (pb < 0 || pb > PB_MAX) {
            throw new IllegalArgumentException(
     ...
     * The default is {@code MODE_FAST} for presets 0-3 and {@code MODE_NORMAL}
     * for presets 4-9.
     * <p>
     * Usually {@code MODE_FAST} is used with Hash Chain match finders and
     * {@code MODE_NORMAL} with Binary Tree match finders. This is also what the
     * presets do.
     * <p>
     * The special mode {@code MODE_UNCOMPRESSED} doesn't try to compress the
     * data at all (and doesn't use a match finder) and will simply wrap it in
     * uncompressed LZMA2 chunks.
     *
     * @throws IllegalArgumentException {@code mode} is not supported
     */
    ...
    /**
     * Sets the nice length of matches. Once a match of at least {@code niceLen}
     * bytes is found, the algorithm stops looking for better matches. Higher
     * values tend to give better compression at the expense of speed. The
     * default depends on the preset.
     *
     * @throws IllegalArgumentException {@code niceLen} is invalid
     */
    public void setNiceLen(int niceLen) throws IllegalArgumentException {
     ...
     * {@code MF_HC4} and 4-9 use {@code MF_BT4}.
     *
     * @throws IllegalArgumentException {@code mf} is not supported
     */
    public void setMatchFinder(int mf) throws IllegalArgumentException {
     ...
     * <p>
     * The default is a special value of {@code 0} which indicates that the
     ...
     * taking far too long.
     *
     * @throws IllegalArgumentException {@code depthLimit} is invalid
     */
