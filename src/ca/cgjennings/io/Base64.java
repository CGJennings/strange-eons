 ...
 *
 * <p>
 * This is based on public domain code written by
 * <a href="http://iharder.net/base64">Robert Harder</a>. The main change is
 * that the inner classes have been renamed, mainly because my IDE wants to add
 * imports for them whenever I use an InputStream or OutputStream. Since this
 * refactoring might cause conflicts with other code that also uses this class,
 * this version has been moved to a different package.
 */
public class Base64 {
     ...
     * without also specifying that it is was encoded using the URL- and
...
//        }
    ...
    public static byte[] decodeFromFile(String filename)
        ...
        try {
            ...
            // Read until done
            while ((numBytes = bis.read(buffer, length, 4_096)) >= 0) {
                length += numBytes;
            }   // end while
    ...
    }   // end inner class Base64OutputStream
}   // end class Base64
