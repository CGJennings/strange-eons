 ...
 * the location of the problem using a <code>long</code> value. If present, this
 * will become part of the message by appending a space and the text "[offset:
 * <i>n</i>]". (If the message is <code>null</code>, then this text will be used
 * as the message.)
 *
