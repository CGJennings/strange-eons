...
//	}
    ...
    /**
     * Returns <i>n</i>! as a {@code long} value. In order to fit within a
     * {@code long}, the value of {@code n} must not be greater than
    ...
    /**
     * A table of the first {@code MAXIMUM_LONG_FACTORIAL} + 1 factorials
     * (including 0!).
     */
     ...
     * <p>
     * Hence, {@code permutations( 3, 2 )} would return 6.
     *
     ...
     * {1,2}, {1,3}, {2,3}
     * <p>
     * Hence, {@code combinations( 3, 2 )} would return 3.
     *
     * @param n the size of the set from which the elements of lists are to be
     * taken
     * @param r the size of the lists to created
