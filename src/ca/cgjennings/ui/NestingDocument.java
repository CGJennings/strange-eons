...
/**
 * This interface should be implemented by {@code Document}s that wrap around
 * other documents to modify their basic functionality. (Such wrapping can be
 * used to simulate the effects of multiple inheritence.) The interface
