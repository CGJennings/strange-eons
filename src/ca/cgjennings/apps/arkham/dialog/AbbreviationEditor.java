...
//			java.util.logging.Logger.getLogger( AbbreviationEditor.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
...
//			@Override
//			public void run() {
//				AbbreviationEditor dialog = new AbbreviationEditor( new javax.swing.JFrame(), false );
