...
public final class DictionaryEditor extends javax.swing.JDialog implements AgnosticDialog {
    ...
    private void initComponents() {
        ...
        corpusFormatCombo.setModel( new javax.swing.DefaultComboBoxModel( new String[] { string("dicted-freq-fmt-0"), string("dicted-freq-fmt-1"), string("dicted-freq-fmt-2") } ) );
	...
	private void processStatsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processStatsBtnActionPerformed
            final ListModel m = statList.getModel();
            if (m.getSize() == 0) {
                return;
            }
    ...
    private javax.swing.JComboBox corpusFormatCombo;
    ...
    private javax.swing.JComboBox policyChainCombo;
