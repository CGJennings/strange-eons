...
final class PluginContextImpl implements PluginContext {
     ...
     * plug-in can be {@code null} if a dummy context is required; this is
     ...
     * {@code null}, will be requested from the installedPlugin
     * @param modifiers if the plug-in is being activated, the mask for the
     * modifier keys that are held down; otherwise 0
     * @param isProbe {@code true} to set the context's information probe
