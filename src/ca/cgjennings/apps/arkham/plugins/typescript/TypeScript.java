...
/**
 * The primary method of accessing TypeScript language services. This class
 * allows you to hand off service requests to be performed in the background. A
 * callback that you provide will be called with the result once it is
 * available.
 *
...
public final class TypeScript {
    ...
    /**
     * Suggests to the service that it should prepare to be used soon. If the
     * service is already running, this method returns immediately.
     */
     ...
     *
     * @param callback will be called with a non-null version string, such as
     * "4.2.0-dev"
     */
    ...
    /**
     * Transpiles the specified source code from TypeScript to JavaScript, using
     * default options.
     *
    ...
    /**
     * Restarts the service provider. This can be called during development to
     * pick up changes to the service implementation without restarting the app.
     */
