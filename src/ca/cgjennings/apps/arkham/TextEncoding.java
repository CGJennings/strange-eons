 ...
 * across Strange Eons for various purposes. This class presents a single source
 * of truth for these encodings. This class contains both names and
 * {@link Charset} instances for all of the major text encodings used by Strange
 * Eons. Except for UTF-8, the members are named for their purpose rather than
...
public final class TextEncoding {
    ...
    /**
     * Name of the encoding used for HTML and CSS resources ({@code .html},
     * {@code .css}).
     */
    ...
    /**
     * Name of the encoding used for files processed with a
     * {@link ResourceParser}.
     */
    ...
    /**
     * Name of the encoding used for source code ({@code .ajs}, {@code .js},
     * {@code .ts}, etc.).
     */
