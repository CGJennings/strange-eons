...
//		ta.add( new NewAction( string("pa-new-"), string("pa-new--name"), "js", "projects/new-.js", NewTaskType.PLUGIN_TYPE ) );
        ...
        ta.add(new NewAction(string("pa-new-conversionmap"), string("pa-new-conversionmap-name"), "conversionmap", "projects/new-conversionmap.txt", MetadataSource.ICON_CLASS_MAP, NewTaskType.PLUGIN_TYPE));
