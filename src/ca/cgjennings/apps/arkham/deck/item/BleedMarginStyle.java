...
public interface BleedMarginStyle extends Style {
    /**
     * Returns the finish style set on this item, or
     * null if the deck default style should be used.
     * 
    ...
    /**
     * Sets the edge finish style to use for this item,
     * or null if the deck default option should be used.
     * 
    ...
    /**
     * Returns the bleed margin width to use when the relevant finish
     * option is selected.
     * 
    ...
    /**
     * Sets the bleed margin width to use when the relevant finish
     * option is selected.
     * 
