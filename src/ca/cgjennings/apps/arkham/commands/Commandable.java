...
public interface Commandable {
     ...
     * could return true from <code>handlesCommand</code>, but false from
    ...
    /**
     * Returns <code>true</code> if the <code>command</code> can be performed by
     ...
     *
     * @param command the command to be performed
     * @return <code>true</code> if this commandable can currently perform the
     * command
     */
     ...
     * <code>false</code> for this command, then this should do nothing.
     *
