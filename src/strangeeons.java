 ...
 * {@code main()} method of {@link ca.cgjennings.apps.arkham.StrangeEons}. This
 * allows starting the application using a command such as:
 ...
 * it is packaged as an {@code .app}. This secondary purpose is activated by
 * passing {@code --tool} as the first parameter. In this case, the launcher
 * looks for a class with the specified name in the default package and tries to
 * invoke its static main method to start it. All arguments after the tool name
 * are passed to the tool. Applicable tools include
