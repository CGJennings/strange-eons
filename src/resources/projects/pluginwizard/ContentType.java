...
public enum ContentType implements IconProvider {
    ...
    /**
     * Returns the file name extension, including initial dot, used by plug-in
     * bundles that store plug-ins of this type.
     *
     * @return the file name extension for the plug-in type, such as
     * ".seplugin".
     */
