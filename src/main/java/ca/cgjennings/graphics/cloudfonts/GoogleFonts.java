...
/**
 * A cloud font collection that is backed by the Google Fonts
 * repository.
 * 
 * @author Chris Jennings <https://cgjennings.ca/contact>
 */
final class GoogleFonts implements CloudFontCollection {
    private static final long MAX_CACHE_AGE = 30L * 24 * 60 * 60 * 1000;
    private static final String HASHES = "hashes";
    private static final String METADATA = "metadata";

    GoogleFonts(CloudFontConnector provider) {
    ...
    static class GoogleFontFamily implements CloudFontFamily {
        protected GoogleFontFamily(GoogleFonts collection, String key, String fileList) {
        ...
        private final GoogleFonts coll;
        private String key;
    ...
    public static void main(String[] args) {
        try {
            GoogleFonts gfc = (GoogleFonts) CloudFonts.getDefaultCollection();
