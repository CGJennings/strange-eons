    ...
    private void initComponents() {
        ...
        localeFilter.getDocument().addDocumentListener( new DocumentEventAdapter() {
            ...
            public void changedUpdate( DocumentEvent e ) {
                ...
                ((FilteredListModel<LanguageCodeDescriptor>) locList.getModel()).setFilter( new FilteredListModel.ListFilter<LanguageCodeDescriptor>() {
                    @Override
                    public boolean include( FilteredListModel<LanguageCodeDescriptor> model, LanguageCodeDescriptor item ) {
                        if( item == null ) return false;
                        Locale loc = item.getLocale();
                ...
                if( selValues.size() > 0 ) {
                    ListModel<LanguageCodeDescriptor> m = locList.getModel();
