...
public interface ProgressListener extends EventListener {
     ...
     * completion. If the listener returns {@code true}, it is a hint that the
     * operation should be cancelled if possible.
     *
     * @param source the source of the progress event
     * @param progress a value between 0 (none) and 1 (algorithm complete)
     * @return {@code true} if the callee wishes to hint that the algorithm be
     * cancelled
     */
