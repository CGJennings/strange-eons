...
class BZip2OutputStream extends OutputStream
     ...
     * very generous.  </p>
     */
    protected static final int QSORT_STACK_SIZE = 1_000;
     ...
     */
    private BZip2OutputStream.Data data;
     ...
     * <tt>BZip2OutputStream</tt>.
     */
    public static int chooseBlockSize(long inputLength) {
        return (inputLength > 0) ? (int) Math
                .min((inputLength / 132_000) + 1, 9) : MAX_BLOCKSIZE;
    }

    /**
     * Constructs a new <tt>BZip2OutputStream</tt> with a blocksize of 900k.
     *
     * <p>
    ...
    /**
     * Constructs a new <tt>BZip2OutputStream</tt> with specified blocksize.
     *
     * <p>
     * <b>Attention: </b>The caller is resonsible to write the two BZip2 magic
     * bytes <tt>"BZ"</tt> to the specified stream prior to calling this
     ...
     * @see #MAX_BLOCKSIZE
     */
    public BZip2OutputStream(final OutputStream out, final int blockSize)
            throws IOException {
        super();
    ...
    private void sendMTFValues() throws IOException {
        ...
        final int nGroups = (this.nMTF < 200) ? 2 : (this.nMTF < 600) ? 3
                : (this.nMTF < 1_200) ? 4 : (this.nMTF < 2_400) ? 5 : 6;
 ...
 /*
                 ...
                 */
                int bt = -1;
                for (int t = nGroups, bc = 999_999_999; --t >= 0;) {
