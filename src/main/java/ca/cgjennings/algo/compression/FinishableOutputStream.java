...
abstract class FinishableOutputStream extends OutputStream {
     ...
     * <p>
     * The {@code finish} method of {@code FinishableOutputStream} does nothing.
     * Subclasses should override it if they need finishing support, which is
     * the case, for example, with compressors.
     *
     * @throws IOException
     */
