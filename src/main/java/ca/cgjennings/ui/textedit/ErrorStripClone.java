...
// This is a clone of  org.fife.ui.rsyntaxarea.ErrorStrip
// including changes I submitted in a pull request to the original project.
// Ideally the PR will be accepted, and when the library is updated,
// the class ErrorStrip in this package can be updated to
// extend that instead of this.
...
//       are now "empty").
//
class ErrorStripClone extends JPanel {
	 ...
	 */
	public ErrorStripClone(RSyntaxTextArea textArea) {
