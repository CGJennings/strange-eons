...
public final class CodeFormatPage extends javax.swing.JPanel {
    ...
    /**
     * Sets whether the compiled plug-in option (if {@code true}) or scripted
     * option (if {@code false}, the default).
     *
    ...
    /**
     * Returns {@code true} if the compiled code option has been selected, or
     * {@code false} if the script code option is selected.
     *
